...
int PLenclave_create(struct PLenclave* PLenclave, struct elf_args* u_elffile, struct enclave_args* u_param)
{
  ...
  PLenclave->user_param.wasm_vm_mr_ptr = u_param->wasm_vm_mr_ptr;
  PLenclave->user_param.wasm_vm_mr_size = u_param->wasm_vm_mr_size;
  PLenclave->user_param.wasm_ptr = u_param->wasm_ptr;
  PLenclave->user_param.wasm_size = u_param->wasm_size;
